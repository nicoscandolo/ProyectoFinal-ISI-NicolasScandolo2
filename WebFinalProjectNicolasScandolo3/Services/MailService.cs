        ...
        public async Task SendEmailAsync(MailRequest request)
        {
            ...
            switch (request.tipo)
            {
                case "upload":
                    ...
                    MailText = MailText.Replace("[Titulo]", "Hey!!").Replace("[Leyenda]","Un usuario acaba de subir un archivo en uno de tus grupos");
                    break;
                case "consulta":
                    email.Subject = "Hey, una consulta acaba de ser publicada en E-Group";
                    MailText = MailText.Replace("[Titulo]", "Hey!!").Replace("[Leyenda]", "Un usuario acaba de realizar una consulta en uno de tus grupos");
                    break;
                case "welcome":
                    ...
                    break;
                case "welcomeGroup":
                    email.Subject = "Hey, acabas de ser agregado a un nuevo grupo";
                    MailText = MailText.Replace("[Titulo]", "Hey!!").Replace("[Leyenda]", "Acabas de ser agregado a un grupo en E-Group. Accede a nuestra web para saber como continuar");
                    break;
                default:
                    // Default stuff
                    break;
